...
@section('content')
    <div class="container">
        ...
        {{-- {{ route('login.post') }} --}}
        <form action="{{ route('login.factor') }}" method="post" class="ms-auto me-auto mt-auto" style="width: 500px"
            ...
            <div>
                <a class="btn btn-primary mt-2" href="{{ route('forget.password') }}">Forgot password?</a>
            </div>
        </form>
